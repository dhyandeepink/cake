...
<head>
	...
	<?php echo $this->Html->script('stm31'); ?>
	<?php echo $this->Html->css('paging'); ?>
	<?php echo $this->Html->css('menu_admin'); ?>
		<title>
...
<table align="center" width="780" cellpadding="0" cellspacing="0">
	<tr>
		...
		<?php echo $this->Html->link(__('Home', true), '../admin/index'); ?><br><br>
		
<div id="menu"> Input Data : <br>
<ul><li> <?php echo $this->Html->link(__('Admin', true), '../Users/add/'); ?> </li><br>
	<li> <?php echo $this->Html->link(__('Koordinator', true), '../Koordinators/add/'); ?> </li><br>
	<li> <?php echo $this->Html->link(__('Tipe Barang', true), '../Masters/add/'); ?> </li><br>
	<li> <?php echo $this->Html->link(__('Harga Barang', true), '../Barangs/add/'); ?> </li><br>
	<li> <?php echo $this->Html->link(__('Pasar', true), '../Pasars/add/'); ?> </li><br><br>
